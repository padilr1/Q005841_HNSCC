...
## All samples
```{r echo = FALSE, warning=FALSE,message=FALSE,out.width='100%',fig.cap="Top 500 most variably expressed genes used; Circles = new batch; Triangles = old batch"}
...
## FaDu & SKN3
```{r echo = FALSE, warning=FALSE,message=FALSE,out.width='100%'}
vst.fadu.skn3 <- vst[ , vst$cell_line %in% c("FaDu","SKN3")]
