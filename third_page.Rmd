...
Parental samples nicely cluster together. NSD1KO.NSD2OE still clusters closer to the parental samples than to the NSD1KO samples. 
...
E2F targets genes that encode proteins involved in DNA replication.
...
Surprisingly, in NSD.TKO, oxidative phosphorylation is actually downregulated.
...
We observe upregulation for NSD.DKO and 1 sample of NSD.1KO. However, unexpectedly, we also observe a similar upregulation of oxidative phosphorylation for Cal27_OE.K36WT (which resembled parental samples in the PCA). 
